...
<div class="relative sm:flex sm:justify bg-white">
    <a class="sm:fixed sm:top-0 sm:left-0 p-6 z-10 text-2xl text-black font-bold" href="/">Timely</a>
    @if (Route::has('login'))
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            @auth
                <a href="{{ url('/dashboard') }}" class="font-medium text-black uppercase btn btn-ghost">Dashboard</a>
            @else
                <a href="{{ route('login') }}" class="font-medium text-black uppercase btn btn-ghost">Log in</a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}"
                       class="font-medium text-black uppercase btn btn-ghost">Register</a>
                @endif
            @endauth
        </div>
    @endif
...
<div class="hero bg-white min-h-screen">
    <div class="hero-content flex-col lg:flex-row">
        ...
        <div class="mt-28">
            <h1 class="text-5xl font-bold text-black">Simple Meeting Page: Info, Times, and Easy Voting.</h1>
            <p class="py-6 text-black">Simplify your meetings with our user-friendly Meeting Page! Find essential
...
<div class="hero min-h-screen bg-white">
    <div class="hero-content flex-col lg:flex-row-reverse">
        <img src="{{ asset('img/addtimes.png') }}" class="max-w-2xl rounded-lg shadow-2xl"
             alt="Meeting page"/>
        <div>
            <h1 class="text-5xl font-bold text-black">Effortless Date and Time Selection with Simple Calendar.</h1>
            <p class="py-6 text-black">Our simple calendar feature is designed to take the hassle out of date and time
...
<div class="hero min-h-screen" style="background-image: url({{ asset('img/dashboard.png') }});">
    ...
    <a href="{{ route('dashboard') }}">
        <button class="btn btn-primary bg-purple-500 border-purple-500 mt-56">Get Started.</button>
    </a>
</div>
</body>

<footer class="footer p-5 bg-gray-100 text-black">
    <div>
        <p class="text-xl font-bold uppercase">Kibernetiku klubas</p>
        <p class="text-md">Timely, a meeting scheduling and time managing web app
            Copyright (C) 2023 Kibernetiku klubas</p>
    </div>
    <div>
        <span class="footer-title">Kontaktai</span>
